// Todo dentro de DOMContentLoaded para evitar problemas de timing
document.addEventListener('DOMContentLoaded', () => {
  ...
  const closeCameraBtn = document.getElementById('closeCamera'); // lo mantenemos oculto
  ...
  function setCameraOpenUI() {
    // cuando la cámara está abierta: el mismo botón sirve para cerrar
    openCameraBtn.style.display = 'inline-block';
  ...
  openCameraBtn.addEventListener('click', () => {
    // si está abierta, cerrar; si está cerrada, abrir
